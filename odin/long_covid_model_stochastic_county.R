...
into_long_non_hosp[,,,,] <- delay(infection_in_to_long_non_hosp[i, j, k, l, i5] + cases_in_to_long_non_hosp[i, j, k, l, i5], case_delay)
...
leaving_long_non_hosp_recovery[,,,,] <- rbinom(leaving_long_non_hosp[i, j, k, l, i5] - leaving_long_non_hosp_death[i, j, k, l, i5], (recovery_rate_non_hosp * recover_non_hosp)/(recovery_rate_non_hosp * recover_non_hosp + permanent_non_hosp_prop))
leaving_long_non_hosp_permanent[,,,,] <- leaving_long_non_hosp[i, j, k, l, i5] - leaving_long_non_hosp_death[i, j, k, l, i5] - leaving_long_non_hosp_recovery[i, j, k, l, i5]
#Set up hospitalization
into_long_hosp[,,,,] <- delay(rbinom(hospitalization[i, j, k, l, i5, as.integer(step)], hosp_long_hosp_upd[i, j, k, l]), case_delay)
...
leaving_long_hosp_recovery[,,,,] <- rbinom(leaving_long_hosp[i, j, k, l, i5] - leaving_long_hosp_death[i, j, k, l, i5], (recovery_rate_hosp * recover_hosp)/(recovery_rate_hosp * recover_hosp + permanent_hosp_prop))
leaving_long_hosp_permanent[,,,,] <- leaving_long_hosp[i, j, k, l, i5] - leaving_long_hosp_death[i, j, k, l, i5] - leaving_long_hosp_recovery[i, j, k, l, i5]
